...
int main(void)
{
  ...
  MX_GPIO_Init();
  MX_TIM2_Init(); // Temporizador para el botón de usuario
  MX_TIM3_Init(); // Temporizador para el IR 1
  MX_TIM4_Init(); // Temporizador para el IR 2
  MX_TIM5_Init(); // Temporizador para el IR 3
  MX_ADC1_Init(); // Conversor AD para el potenciómetro
  MX_TIM9_Init(); // Temporizador para el PWM del ADC1
  /* USER CODE BEGIN 2 */
  ...
  while (1)
  {
	  ...
	  TIM9->CCR1 = (AD_RES<<4); // Update The PWM Duty Cycle With Latest ADC Conversion Result
    /* USER CODE END WHILE */
